  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">모집 분야</h2>
          ...
          <Card className="border-blue-100 shadow-md hover:shadow-lg transition-shadow duration-300 max-w-4xl mx-auto">
            <CardContent className="p-8">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="w-full md:w-1/3 bg-blue-50 rounded-lg p-6 text-center">
                  <h3 className="text-xl font-bold text-blue-700 mb-3">재무, 보험 컨설팅</h3>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">급여 및 조건</h2>
            <div className="w-16 h-1 bg-blue-500 mx-auto rounded-full mb-6"></div>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">급여</h3>
              <p className="text-gray-600">월 평균 급여(성과제)</p>
              <p className="text-blue-600 font-bold text-2xl mt-2">500만원</p>
              <p className="text-gray-600 mt-1">+ 상여금 600%</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">근무 일수</h3>
              <p className="text-gray-600">주 5일 근무</p>
              <p className="text-blue-600 font-bold text-2xl mt-2">월~금</p>
              <p className="text-gray-600 mt-1">주말 및 공휴일 휴무</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">근무 시간</h3>
              <p className="text-gray-600">정규 영업시간</p>
              <p className="text-blue-600 font-bold text-2xl mt-2">9:00 - 18:00</p>
              <p className="text-gray-600 mt-1">점심시간 포함</p>
            </motion.div>
          </div>
        </div>
      </motion.section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            >
              ...
              <h3 className="font-semibold text-gray-800">구내 라운지, 카페</h3>
              <p className="text-sm text-gray-600 mt-2">휴식과 소통을 위한 편안한 공간</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-800">무료 헬스장</h3>
              <p className="text-sm text-gray-600 mt-2">임직원 건강 관리 지원</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-800">넓은 주차공간</h3>
              <p className="text-sm text-gray-600 mt-2">차량 이용 직원을 위한 편의</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-800">경조사비</h3>
              <p className="text-sm text-gray-600 mt-2">임직원 경조사 지원</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-800">인센티브</h3>
              <p className="text-sm text-gray-600 mt-2">성과에 따른 추가 보상</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-800">해외여행</h3>
              <p className="text-sm text-gray-600 mt-2">우수 실적자 해외여행 지원</p>
            </motion.div>

            <motion.div
              custom={6}
              variants={cardVariants}
              className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 text-center col-span-1 sm:col-span-2 lg:col-span-2"
            >
              <div className="bg-blue-50 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
                <Briefcase className="w-6 h-6 text-blue-500" />
              </div>
              <h3 className="font-semibold text-gray-800">업무지원</h3>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">업무 지원</h2>
            <div className="w-16 h-1 bg-blue-500 mx-auto rounded-full mb-6"></div>
            <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      >
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-8">지금 바로 시너지그룹과 함께하세요</h2>
          ...
          {/* <Button
            className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 mx-auto"
            onClick={handleApply}
