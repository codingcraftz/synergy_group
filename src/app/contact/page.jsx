...
export default function Contact() {
  ...
  return (
    <div className='w-full min-h-screen flex flex-col items-center bg-gray-50 text-gray-900'>
      ...
      >
        <Image src='/contact.jpg' fill style={{ objectFit: 'cover' }} alt='contact' className='brightness-75' />
        <div className='absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center'>
          ...
          >
            <motion.div
              ...
              className='w-32 h-1 bg-[#90ccef] mx-auto rounded-full'
            />
            <h1 className='text-4xl md:text-6xl font-bold text-white'>Contact Us</h1>
            <p className='text-xl text-gray-200'>언제든지 문의해 주세요. 최선을 다해 도와드리겠습니다.</p>
            <motion.div
              initial={{ scale: 0.9, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
              ...
              <div>
                ...
                />
                {errors.representative && <p className='mt-1 text-sm text-red-600'>{errors.representative.message}</p>}
              </div>
